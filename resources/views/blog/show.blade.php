<x-main-layout>
    @seo([
        'title' => ($blog->meta_title ?: $blog->title) . ' | Your Journey Voices',
        'description' => $blog->meta_description ?: ($blog->excerpt ?: \Illuminate\Support\Str::limit(strip_tags($blog->content), 160)),
        'keywords' => 'Christian blog, inspirational stories, faith-based content, ' . strtolower($blog->title),
        'image' => $blog->og_image ?: ($blog->featured_image ? asset('storage/' . $blog->featured_image) : asset('images/blog-post-og.jpg')),
