<x-admin-layout>
    <div class="space-y-6">
        ...
        <!-- Form -->
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 px-6 py-4">
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <button type="submit" 
                        ...
                        <span x-text="submitting ? 'Creating Product...' : 'Create Product'"></span>
                    </button>
                </div>
            </div>
        </form>
