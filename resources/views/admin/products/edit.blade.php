<x-admin-layout>
    <div class="space-y-6">
        ...
        <!-- Form -->
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            @include('admin.partials.seo-fields', ['model' => $product])
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button type="submit" 
                            ...
                            <span x-text="submitting ? 'Updating Product...' : 'Update Product'"></span>
                        </button>
                    </div>
                </div>
            </div>
